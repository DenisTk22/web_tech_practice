...
const temperatureF = ((9/5) * temperatureC + 32).toFixed(1);

alert(`Ваша температура в градусах Цельсия: ${temperatureC}, ваша температура в градусах Фаренгейта: ${temperatureF}`);
